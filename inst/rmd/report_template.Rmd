...
spectra_data_iso_adduct <- spectra(ChromPeaks.data)
...
for (iso_cc in seq_along(spectra_data_iso_adduct)[1:4]  ) {
  ...
  main_result <- summary(findMAIN(spec = current_spectra_df))
